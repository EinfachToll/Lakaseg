...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	Graph_mf<captype_mf, tcaptype, flowtype_mf>::Graph_mf(int node_num_max, int edge_num_max, void (*err_function)(const char *))
	: node_num(0),
	  nodeptr_block(NULL),
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	Graph_mf<captype_mf,tcaptype,flowtype_mf>::~Graph_mf()
{
	if (nodeptr_block) 
	{ 
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	void Graph_mf<captype_mf,tcaptype,flowtype_mf>::reset()
{
	node_last = nodes;
	arc_last = arcs;
	node_num = 0;
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	void Graph_mf<captype_mf,tcaptype,flowtype_mf>::reallocate_nodes(int num)
{
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	void Graph_mf<captype_mf,tcaptype,flowtype_mf>::reallocate_arcs()
{
