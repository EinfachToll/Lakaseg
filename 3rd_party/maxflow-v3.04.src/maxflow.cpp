...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	inline void Graph_mf<captype_mf,tcaptype,flowtype_mf>::set_active(node *i)
{
	if (!i->next)
	{
...
*/
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	inline typename Graph_mf<captype_mf,tcaptype,flowtype_mf>::node* Graph_mf<captype_mf,tcaptype,flowtype_mf>::next_active()
{
	node *i;
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	inline void Graph_mf<captype_mf,tcaptype,flowtype_mf>::set_orphan_front(node *i)
{
	nodeptr *np;
	i -> parent = ORPHAN;
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	inline void Graph_mf<captype_mf,tcaptype,flowtype_mf>::set_orphan_rear(node *i)
{
	nodeptr *np;
	i -> parent = ORPHAN;
	np = nodeptr_block -> New();
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	inline void Graph_mf<captype_mf,tcaptype,flowtype_mf>::add_to_changed_list(node *i)
{
	if (changed_list && !i->is_in_changed_list)
	{
		node_id_mf* ptr = changed_list->New();
		*ptr = (node_id_mf)(i - nodes);
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	void Graph_mf<captype_mf,tcaptype,flowtype_mf>::maxflow_init()
{
	node *i;
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	void Graph_mf<captype_mf,tcaptype,flowtype_mf>::maxflow_reuse_trees_init()
{
	node* i;
	node* j;
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	void Graph_mf<captype_mf,tcaptype,flowtype_mf>::augment(arc *middle_arc)
{
	node *i;
	arc *a;
	tcaptype bottleneck;
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	void Graph_mf<captype_mf,tcaptype,flowtype_mf>::process_source_orphan(node *i)
{
	node *j;
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	void Graph_mf<captype_mf,tcaptype,flowtype_mf>::process_sink_orphan(node *i)
{
	node *j;
	arc *a0, *a0_min = NULL, *a;
	int d, d_min = INFINITE_D;
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	flowtype_mf Graph_mf<captype_mf,tcaptype,flowtype_mf>::maxflow(bool reuse_trees, Block<node_id_mf>* _changed_list)
{
...
template <typename captype_mf, typename tcaptype, typename flowtype_mf> 
	void Graph_mf<captype_mf,tcaptype,flowtype_mf>::test_consistency(node* current_node)
{
	node *i;
	arc *a;
	int r;
